...
mimic_ori2_path = f"/app/MedHEval/benchmark_data/Knowledge_Deficiency_Hallucination/close-ended/MIMIC-CXR_sampled.json"
...
mimic_ori3_path = f"/app/MedHEval/benchmark_data/Context_Misalignment_Hallucination/MIMIC-CXR_pairs.json"
...
if __name__ == "__main__":
    ...
    for model in models:
        infer_path_type2 = f"{root_path}MedHEval/pred/{backbone}/{model}/type2/close_ended/pred_{model}.jsonl"
        infer_path_type3 = f"{root_path}MedHEval/pred/{backbone}/{model}/type3/close_ended/pred_{model}.jsonl"
        slake_f_accs, slake_f_accs3 = eval_mimic_single(infer_path_type2, infer_path_type3)
        
        res_path = f"{root_path}MedHEval/pred/{backbone}/{model}/type3/{model}_type2&3.txt"
