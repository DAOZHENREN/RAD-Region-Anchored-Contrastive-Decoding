...
def run_inference(model_path, cuda):
    ...
    # overrides = '{"model":{"embedder":{"token_embedders":{"bert":{"model_name":"/app/Models/microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext"}}}}}'
    # os.system(f"PYTHONPATH=/app/dygiepp:$PYTHONPATH allennlp predict {model_path} {data_path} \
    ...
    "model": {
        ...
        "token_embedders": {
            "bert": {
            "model_name": "/app/Models/hub/models--microsoft--BiomedNLP-BiomedBERT-base-uncased-abstract-fulltext/snapshots/e1354b7a3a09615f6aba48dfad4b7a613eef7062"
            }
        }
        }
    },
    "dataset_reader": {"token_indexers": {"bert": {"model_name": "/app/Models/hub/models--microsoft--BiomedNLP-BiomedBERT-base-uncased-abstract-fulltext/snapshots/e1354b7a3a09615f6aba48dfad4b7a613eef7062"}}}
    }

    env = os.environ.copy()
    env["PYTHONPATH"] = "/app/MedHEval/code/evaluation/report_eval/CXRMetric/dygiepp:" + env.get("PYTHONPATH", "")
