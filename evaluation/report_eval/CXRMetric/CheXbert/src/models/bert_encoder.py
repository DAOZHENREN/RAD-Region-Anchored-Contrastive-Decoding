...
class bert_encoder(nn.Module):
    def __init__(self, logits, p=0.1, clinical=False, freeze_embeddings=False, pretrain_path="/app/Models/hub/models--google-bert--bert-base-uncased/snapshots/86b5e0934494bd15c9632b12f734a8a67f723594"):
