...
def calc_metric(gt_csv, pred_csv, out_csv, use_idf): # TODO: support single metrics at a time
    ...
    os.system(f"python /app/MedHEval/code/evaluation/report_eval/CXRMetric/CheXbert/src/encode.py -c {CHEXBERT_PATH} -d {cache_pred_csv} -o {pred_embed_path}")
    os.system(f"python /app/MedHEval/code/evaluation/report_eval/CXRMetric/CheXbert/src/encode.py -c {CHEXBERT_PATH} -d {cache_gt_csv} -o {gt_embed_path}")
