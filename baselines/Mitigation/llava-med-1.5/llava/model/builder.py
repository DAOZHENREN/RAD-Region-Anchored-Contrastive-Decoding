...
def load_pretrained_model(model_path, model_base, model_name, peft_path=None, load_8bit=False, load_4bit=False, device_map="auto", device="cuda",attn_implementation=None):
